@extends('layouts.app')
@section('title','Data Riwayat Presensi')
@section('css_section')
    <!-- Favicon -->
...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Riwayat Presensi</h4>

    <!-- Bordered Table -->
    <div class="card">
        <h5 class="card-header">Data Riwayat Presensi</h5>
        <div class="card-body">
            <div class="table-responsive text-nowrap">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>{{ \Carbon\Carbon::parse($item->waktu_awal)->format('H:i:s') }}</td>
                        <td><a href="{{ url(Storage::url($item->foto_awal)) }}"><img src="{{ url(Storage::url($item->foto_awal)) }}" width="40"></a></td>
                        <td>{{ \Carbon\Carbon::parse($item->waktu_akhir)->format('H:i:s') }}</td>
                        <td><a href="{{ url(Storage::url($item->foto_akhir)) }}"><img src="{{ url(Storage::url($item->foto_akhir)) }}" width="40"></a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
