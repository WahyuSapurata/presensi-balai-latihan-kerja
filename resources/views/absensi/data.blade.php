@extends('layouts.app')
@section('title','Data Presensi Peserta')
@section('css_section')
    <!-- Favicon -->
...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Presensi Peserta</h4>

    <!-- Bordered Table -->
    <div class="card">
        <h5 class="card-header">Data Presensi Peserta</h5>
        <div class="card-body">
            <div class="table-responsive text-nowrap">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>{{ $item->email }}</td>
                        <td>
                            <a href="{{ route('absensi.detail', $item->id) }}"><i class="menu-icon tf-icons bx bx-file"></i></a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
